...
class QN_S3VM_Dense:
    ...
    def train(self):
        ...
        predictions = self.__getTrainingPredictions(self.__X, real_valued = True)
        return predictions
    ...
    def predict(self, x):
        ...
        preds = []
        for ins in x:
            pred = self.getPredictions(ins, real_valued=False)[0]
            preds.append(pred)
    ...
    def predictValue(self, x):
        ...
        preds = []
        for ins in x:
            pred = self.getPredictions(ins, real_valued=True)[0]
            preds.append(pred)
